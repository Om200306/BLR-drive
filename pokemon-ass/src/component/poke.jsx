...
export function Poke(){
    ...
    function hendleSubmit(e){
        ...
        let pId=e.target.pokemon.value;
   ...
   <div style={{display:"flex" , flexDirection:"column", alignItems:"center"}}>
    ...
    <select name="pokemon" id="pokemon" style={{width:"80vw" , height:"50px", borderRadius:"12px"}}>
        {
           pokemons.map((ele)=>{
            return(
...
<br />
   ...
   <div style={{width:"20rem", margin:"auto", border:"1px solid white",borderRadius:"12px",padding:"12px"}}>
    <div>
        <img src={poke.image} alt="" width={"100%"}/>
   ...
   <div style={{display:"flex", gap:"12px"}}>
    <button disabled={poke.id==1} onClick={()=>setId(poke.id-1)}>Previous</button>
    <button disabled={poke.id==pokemons.length} onClick={ ()=>setId(poke.id+1)}>Next</button>
   </div>
